    ...
    void Update()
    {
        ...
        {            
            case bossStates.shooting:
                ...
                if(shootCounter <= 0)
                {
                    shootCounter = timeBetweenShots; //reseteamos el tiempo entre shots
                    var newBullet = Instantiate(bullet, firePoint.position, firePoint.rotation);
                    newBullet.transform.localScale = theBoss.localScale; //dependiendo de la escala del boss (1 o -1 por su posición), este va a poder disparar si está corriendo hacia la izquierda o derecha
                }
            ...
            case bossStates.moving:
                if (moveRight)
                {
                    ...
                    {
                        theBoss.localScale = new Vector3(1f,1f,1f); // también podemos escribir -> Vector3.one
                        moveRight = false;
                        EndMovement();
                    }
                }
